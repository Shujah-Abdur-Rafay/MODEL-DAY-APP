...
class _WelcomeGuideState extends State<WelcomeGuide>
  ...
  final List<TourStep> _steps = [
    ...
    const TourStep(
      ...
      description:
          "Personalize your ModelLog experience through your profile. Add the app to your home screen for quick access and manage your preferences.",
      icon: Icons.person,
      gradient: LinearGradient(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Text(
                          _completed ? "Welcome to ModelLog! ✨" : _steps[_currentStep].title,
      ...
      children: [
        ...
        ElevatedButton(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text(_currentStep == _steps.length - 1 ? 'Get Started' : 'Next'),
              if (_currentStep < _steps.length - 1) ...[
